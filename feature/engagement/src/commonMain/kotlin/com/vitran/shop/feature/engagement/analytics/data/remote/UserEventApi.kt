...
import com.vitran.shop.feature.engagement.analytics.data.remote.dto.UserEventDataDto
...
internal class UserEventApi(
    private val client: HttpClient,
    private val environment: ApiEnvironment,
    private val executor: ApiRequestExecutor,
) {
    suspend fun track(request: UserEventRequestDto): AppResult<UserEventDataDto> =
        executor.execute {
            client.post(environment.apiUrl("/events")) {
